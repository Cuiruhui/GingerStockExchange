...
else if($act=='save') //保存注册信息
{
	...
	else
	{
		...
		if($demo=='0')
		{
			mb("恭喜您，注册会员成功！请登录系统后尽快进行在线充款，开始您的财富之旅！提示：交易有风险，入市请谨慎！","wlogin.php",1);
		}
		else
		{
			mb("注册用户成功，交易有风险，入市请谨慎，请登录！","wlogin.php",1);
		}
	 }
}
$stype = $_REQUEST['utype'];
$bfchar = 'u';
$email = '';
$qq = '';
$realname = '';
...
$xltm->tpls->LoadTemplate("./tmpfiles/wreg.html");
$xltm->tpls->Show();
?>
