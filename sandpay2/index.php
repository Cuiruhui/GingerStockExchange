	            ...
	            <div id="body" style="clear:left">
	                <dl class="content">
	                    ...
	                    <dd>
	                      ...
	                      <input type="text" name="mid" value="14904142"/>
	                    </dd>
	                    <dt>[orderCode]商户订单号:</dt>
	                    <dd>
	                        <span class="null-star">*</span>
	                        <input type="text" name="orderCode" value="<?php echo "2018050000".time();?>"/>
	                    </dd>
	                    ...
	                    <dd>
	                        <span class="null-star">*</span>
	                       <input type="text" name="subject" value='product'/>
	                    </dd>
	                    <dt>[body]订单描述:</dt>
	                    <dd>
	                        <span class="null-star">*</span>
	                        <input type="text" name="body"  value='products'/>
	                    </dd>
	                    <dt>[txnTimeOut]订单超时时间:</dt>
	                    <dd>
	                        <span class="null-star">*</span>
	                        <input type="text" name="txnTimeOut"  value='20181230000000'/>
	                    </dd>
	                    <dt>[payMode]支付模式:</dt>
	                    <dd>
	                        <span class="null-star">*</span>
	                    ...
	                    <dd>
	                        <span class="null-star">*</span>
	                        <input type="text" name="notifyUrl" value='http://www.yinxiaodai.com/sandpay_gateway/notifyUrl.php'>
	                    </dd>
	                    <dt>[frontUrl]前台通知地址:</dt>
	                    <dd>
	                        <span class="null-star">*</span>
	                       	<input type="text" name="frontUrl" value='http://www.yinxiaodai.com/sandpay_gateway/qiantaiUrl.php'>
	                    </dd>
	                    <dt>[extend]扩展域:</dt>
	                    <dd>
	                        <span class="null-star">*</span>
