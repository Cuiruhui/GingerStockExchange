...
//define API_HOST = 'https://cashier.sandpay.com.cn/gateway/api';测试环境地址
//define PUB_KEY_PATH = 'cert/sand.cer';测试环境公钥 
//define PRI_KEY_PATH = 'cert/syao0507.pfx';测试环境私钥
//define CERT_PWD = '112233'; 私钥证书密码

define("API_HOST", "https://cashier.sandpay.com.cn/gateway/api");
define("PUB_KEY_PATH", "cert/gyao2018520.cer");
define("PRI_KEY_PATH", "cert/siyao201808520.pfx");
define("CERT_PWD", "112233");
  ...
  return iconv('UCS-2BE','UTF-8',pack('H4',$matchs[1]));
	...
	function json_encodes( $array ){
        ...
        if(version_compare(PHP_VERSION,'5.4.0','<')){
            ...
            $str = preg_replace_callback("#\\\u([0-9a-f]{4})#i","next_shuzhu",$str);
            return $str;
        }else{
