...
if($xltm->user_info['username']){
	if($_POST)
	{
		...
		print "<script type='text/javascript'>parent.ymPrompt.succeedInfo({title:'系统设置',message:'保存系统设置信息成功！',handler:function(){self.location.href='system_setup.php';}});</script>";
		exit();
	}
