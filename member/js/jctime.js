...
(function($) {
  ...
  $.fn.jclock = function(options) {
    ...
    return this.each(function() {
      ...
      $this.daysAbbrvNames[0] = "星期日";
      $this.daysAbbrvNames[1] = "星期一";
      $this.daysAbbrvNames[2] = "星期二";
      $this.daysAbbrvNames[3] = "星期三";
      $this.daysAbbrvNames[4] = "星期四";
      $this.daysAbbrvNames[5] = "星期五";
      $this.daysAbbrvNames[6] = "星期六";
