...
$.extend($.validator, {
	...
	messages: {
		...
		maxlength: $.validator.format("请不要输入超出 {0} 位字符."),
		minlength: $.validator.format("至少输入 {0} 位字符."),
		rangelength: $.validator.format("请输入 {0} 至 {1} 的字符."),
		range: $.validator.format("请输入 {0} 至 {1} 的数值."),
